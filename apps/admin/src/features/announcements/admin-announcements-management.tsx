 ...
 * 管理员公告管理面板
 *
 * 职责：公告 CRUD（创建/编辑/发布/下线/删除）。
 * 使用方：admin 公告管理页面
 * 关键依赖：@repo/shared/announcements（server actions）、@repo/ui
 *
 * 本文件从 apps/web/src/features/announcements/admin-announcements-management.tsx
 * 迁移而来；所有数据操作通过 @repo/shared/announcements 的 server actions 完成，
 * 不含 app-local 依赖。
 */
