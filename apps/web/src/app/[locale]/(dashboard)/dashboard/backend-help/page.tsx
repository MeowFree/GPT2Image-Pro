...
`,
    ...
    codex: {
      ...
      valid: [
        ...
        "页面 Chat 模式只提供普通多模态对话/生图语义；页面 Agent 模式默认提供 image_generation、web_search、code_interpreter，不强制 tool_choice，并会多轮续跑，让模型像 Codex 一样按需联网、分析上传文本文件、生成草图和迭代改版。",
...
`,
          ...
          notes: [
            ...
            "Page Chat mode uses normal multimodal chat/image semantics. Agent mode provides image_generation, web_search, and code_interpreter by default without forcing tool_choice, and can continue across automatic rounds. Unsupported tools are removed and retried.",
    ...
    codex: {
      ...
      valid: [
        ...
        "Page Chat mode uses normal multimodal chat/image semantics. Page Agent mode provides image_generation, web_search, and code_interpreter by default without forcing tool_choice, and can continue across automatic rounds so the model can search, analyze uploaded text files, generate drafts, and refine like Codex.",
