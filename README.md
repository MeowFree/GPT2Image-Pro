...
- 当前 `gpt2image.superapi.buzz` 线上 AB 部署 Runbook：[docs/deploy-superapi.md](docs/deploy-superapi.md)。这是本站生产环境的运维记录，只有使用同样的 Nginx 静态 alias、systemd release 和 AB 切换方式时才需要照做；普通部署按下方生产部署即可。
